...
namespace MetricsManager.Jobs
{
    public class RamMetricJob : IJob
    {
        ...
        public RamMetricJob(IRamMetricsRepository repository, IAgentsRepository agentsRepository, IMetricsAgentClient client)
        {
        ...
        public Task Execute(IJobExecutionContext context)
        {
            ...
            {
                var metricsList = _client.GetAllRamMetrics(new GetAllRamMetricsApiRequest
                {
